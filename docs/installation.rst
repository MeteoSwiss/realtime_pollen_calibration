...
Again, there are two options for installation, binary production installations and development (source) installations which are editable. Go to the root folder of realtime-pollen-calibration. Then type
...
.. code-block:: console
    ...
    $ conda env export dev-realtime-pollen-calibration requirements/dev-environment.yml
