...
&Process
  in_file="/store/s83/osm/KENDA-1/ANA22/det/laf<yyyymmddhh:2022031810>"
  out_file="betu_pollen_modelled_values_2022032309.atab"
  out_type="XLS_TABLE", out_type_text1="ATAB", out_type_noundef=.false.
  locgroup="pollen_obs"
  tstart=0, tstop=119, tincr=1
/

&Process in_field="BETU", levlist=80/
